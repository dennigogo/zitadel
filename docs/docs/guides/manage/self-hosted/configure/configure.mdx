...
See a description of all possible _runtime configuration_ options with their defaults [in the source code](https://github.com/dennigogo/zitadel/blob/main/cmd/defaults.yaml).
The `zitadel` binary expects the `--config` flag for this configuration.

### Database Initialization
Apart from these options, ZITADEL uses a [different configuration](https://github.com/dennigogo/zitadel/blob/main/cmd/admin/setup/steps.yaml) for _database initialization steps_.
...
- Check out all possible [runtime configuration properties and their defaults in the source code](https://github.com/dennigogo/zitadel/blob/main/cmd/defaults.yaml)
- Check out all possible [setup step configuration properties and their defaults in the source code](https://github.com/dennigogo/zitadel/blob/main/cmd/setup/steps.yaml)
