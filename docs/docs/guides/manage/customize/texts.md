...
If you need support for a specific language we highly encourage you to [contribute translation files](https://github.com/dennigogo/zitadel/blob/main/CONTRIBUTING.md) for the missing language.
